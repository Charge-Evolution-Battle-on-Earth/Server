...
public class PlaySurrenderResponse {
    ...
    public PlaySurrenderResponse(PlayerType winnerType, PlayerType loserType, Character winner, Character loser, Integer winnerGold, Integer loserGold, Integer winnerExp, Integer loserExp) {
